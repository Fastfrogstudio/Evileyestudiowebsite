...
Generated from `src/lib/mechanicsLibrary.js` by `forge mechanics --doc`. **24 of 56** work today (18 generate code, 6 from a spec setting); 1 adaptable from a shipped math-sdk sample; 26 would have to be built; 5 blocked. 40 reference games indexed.
...
| **Ways (243/1024/…)**<br>`ways_pays` | `config` T0 | ways | Buffalo King Megaways (Pragmatic Play); The Dog House Megaways (Pragmatic Play); Extra Chilli (Big Time Gaming); Razor Ways (Push Gaming); Bonanza Megaways (Big Time Gaming) | Adjacent from the leftmost reel, any row. Ways are the PRODUCT of matching symbols per reel, so a 5x4 board is 1024 ways where a 5x3 is 243. Payouts are per way, which is why a ways paytable must be scaled to the geometry — a 5x3 paytable on a 5x4 board pays 4.2x too much before anything else is considered. |
| **Paylines**<br>`lines_pays` | `config` T0 | lines | Blood Suckers (NetEnt); Mega Joker (NetEnt); R.I.P. City (Hacksaw Gaming); Dork Unit (Hacksaw Gaming); Money Train 3 (Relax Gaming); Iron Bank (Relax Gaming) | Wins run left-to-right along fixed patterns across the reels. The most legible evaluator for a player and the easiest to present, which is why it still carries most hold-and-win and money-symbol games. |

## Round structure

| Mechanic | Status | Works on | From these games | What it does |
|---|---|---|---|---|
| **Tumble / cascade**<br>`tumble` | `built` T2 | cluster, scatter, lines, ways | Sweet Bonanza (Pragmatic Play); Gates of Olympus (Pragmatic Play); Sugar Rush (Pragmatic Play); Fruit Party (Pragmatic Play); Reactoonz (Play'n GO); Aloha! Cluster Pays (NetEnt); Jammin' Jars (Push Gaming); Gonzo's Quest (NetEnt); Samurai Dogs Unleashed (Twist Gaming); Fire in the Hole xBomb (Nolimit City); Bonanza (Big Time Gaming); Buffalo King Megaways (Pragmatic Play); The Dog House Megaways (Pragmatic Play); Extra Chilli (Big Time Gaming); Bonanza Megaways (Big Time Gaming) | Winning symbols are removed, the remainder falls, new symbols drop in, and the board is re-evaluated until no win remains. One round becomes a SEQUENCE of boards, and the win cap is tested against the running round total rather than any single board. |
| **Free spins**<br>`freespins` | `built` T0 | lines, ways, cluster, scatter | Sweet Bonanza (Pragmatic Play); Gates of Olympus (Pragmatic Play); Sugar Rush (Pragmatic Play); Fruit Party (Pragmatic Play); Aloha! Cluster Pays (NetEnt); Gonzo's Quest (NetEnt); Samurai Dogs Unleashed (Twist Gaming); Scroll Keeper (Paperclip Gaming); Big Bass Bonanza (Reel Kingdom / Pragmatic Play); Chaos Crew (Hacksaw Gaming); Razor Shark (Push Gaming); Book of Dead (Play'n GO); Dead or Alive 2 (NetEnt); Bonanza (Big Time Gaming); Jack and the Beanstalk (NetEnt); Mystery Museum (Push Gaming); Big Bass Rock and Roll Enhanced (Pragmatic Play); Buffalo King Megaways (Pragmatic Play); The Dog House Megaways (Pragmatic Play); Extra Chilli (Big Time Gaming); Blood Suckers (NetEnt); Razor Ways (Push Gaming); R.I.P. City (Hacksaw Gaming); Dork Unit (Hacksaw Gaming); Iron Bank (Relax Gaming); Bonanza Megaways (Big Time Gaming) | Scatters trigger a bounded run of spins on a richer reel set, usually with a mechanic the base game does not have. The default home for every multiplier in the library. |
...
| **Selectable feature modes**<br>`multi_mode_feature` | `roadmap` T2 | lines, ways, cluster, scatter | Wanted Dead or a Wild (Hacksaw Gaming); Dead or Alive 2 (NetEnt); R.I.P. City (Hacksaw Gaming) | The trigger picks between two or more free-spin variants — more spins with a lower multiplier, or fewer with a higher one, or an entirely different mechanic per mode. One game with three feature identities. |
...
| **Expanding wild**<br>`expanding_wild` | `built` T3 | lines, ways | Starburst (NetEnt); Blood Suckers (NetEnt) | A wild lands and expands to fill its entire reel, staying for the rest of the free-spin round. A fresh multiplier is rolled onto it on each reveal — the wild is sticky, its multiplier is not. |
| **Sticky wild**<br>`sticky_wild` | `built` T3 | lines, ways | Aloha! Cluster Pays (NetEnt); Scroll Keeper (Paperclip Gaming); Mental (Nolimit City); San Quentin xWays (Nolimit City); Wanted Dead or a Wild (Hacksaw Gaming); Dead or Alive 2 (NetEnt); Mystery Museum (Push Gaming); The Dog House Megaways (Pragmatic Play); Dork Unit (Hacksaw Gaming) | A wild stays in place for the rest of the round. Coverage accumulates, so late spins are worth far more than early ones — the accumulation IS the mechanic, and it is what lets a plain 5x3 payline game reach six figures. |
...
| **Book-style expanding symbol**<br>`expanding_special_symbol` | `roadmap` T2 | lines | Book of Dead (Play'n GO); Dork Unit (Hacksaw Gaming) | One symbol is chosen at the start of the feature. Whenever it lands it expands to fill its reel and pays as both wild and scatter — position stops mattering for that symbol. |
...
| Mechanic | Status | Works on | From these games | What it does |
|---|---|---|---|---|
| **Hold and win (resetting respins)**<br>`hold_and_win` | `built` T3 | lines, ways, cluster | Money Train 2 (Relax Gaming); Money Train 4 (Relax Gaming); Lightning Link (Aristocrat); Money Train 3 (Relax Gaming); Iron Bank (Relax Gaming) | Its own round with its own loop. A prize symbol lands, locks to its cell, and RESETS the respin counter — that reset is the mechanic. When respins run out, every locked prize on the board pays. |
| **Money / cash symbol**<br>`money_symbol` | `built` T1 | lines, ways, cluster | Big Bass Bonanza (Reel Kingdom / Pragmatic Play); Lightning Link (Aristocrat); Le Bandit (Hacksaw Gaming); Big Bass Rock and Roll Enhanced (Pragmatic Play); Money Train 3 (Relax Gaming); Iron Bank (Relax Gaming) | A symbol carrying a cash value that pays directly rather than through the paytable. |
| **Collector**<br>`collector_symbol` | `built` T1 | lines, ways, cluster | Money Train 2 (Relax Gaming); Money Train 4 (Relax Gaming); Big Bass Bonanza (Reel Kingdom / Pragmatic Play); Le Bandit (Hacksaw Gaming); Big Bass Rock and Roll Enhanced (Pragmatic Play); Money Train 3 (Relax Gaming); Iron Bank (Relax Gaming) | A symbol that sweeps every visible money value into itself and pays the total. |
| **Payer**<br>`payer_symbol` | `built` T1 | lines, ways, cluster | Money Train 2 (Relax Gaming); Money Train 4 (Relax Gaming); Money Train 3 (Relax Gaming) | A symbol that ADDS its value to every other money value on screen — the inverse of a collector. |
| **Special symbol taxonomy**<br>`special_symbol_roles` | `roadmap` T2 | lines, ways, cluster | Money Train 2 (Relax Gaming); Money Train 4 (Relax Gaming); Money Train 3 (Relax Gaming) | Not one mechanic but a PATTERN: define a set of symbol roles (collector, payer, sniper, reviver, multiplier) each with a small rule, and let the interactions carry the game. The Money Train school. |
...
| **Mystery stack**<br>`mystery_stack` | `roadmap` T1 | ways, lines | Razor Shark (Push Gaming); Razor Ways (Push Gaming) | A full or partial reel of covered symbols revealing as one type — the stacked form of a mystery symbol. |
...
| Mechanic | Status | Works on | From these games | What it does |
|---|---|---|---|---|
| **Bonus buy**<br>`buy_bonus` | `built` T0 | lines, ways, cluster, scatter | Sweet Bonanza (Pragmatic Play); Gates of Olympus (Pragmatic Play); Sugar Rush (Pragmatic Play); Scroll Keeper (Paperclip Gaming); Money Train 2 (Relax Gaming); Money Train 4 (Relax Gaming); Big Bass Bonanza (Reel Kingdom / Pragmatic Play); Mental (Nolimit City); Fire in the Hole xBomb (Nolimit City); Wanted Dead or a Wild (Hacksaw Gaming); Chaos Crew (Hacksaw Gaming); Le Bandit (Hacksaw Gaming); Buffalo King Megaways (Pragmatic Play); The Dog House Megaways (Pragmatic Play); Extra Chilli (Big Time Gaming); Razor Ways (Push Gaming); R.I.P. City (Hacksaw Gaming); Dork Unit (Hacksaw Gaming); Money Train 3 (Relax Gaming); Iron Bank (Relax Gaming) | Pay a multiple of the stake to enter the feature immediately. |
| **Tiered buy menu**<br>`tiered_buy_menu` | `roadmap` T0 | lines, ways, cluster, scatter | R.I.P. City (Hacksaw Gaming) | Several priced entry points, each configuring the feature differently. |
...
| Mechanic | Status | Works on | From these games | What it does |
|---|---|---|---|---|
| **Variable reel heights**<br>`megaways` | `blocked` T3 | ways | Bonanza (Big Time Gaming); Buffalo King Megaways (Pragmatic Play); The Dog House Megaways (Pragmatic Play); Extra Chilli (Big Time Gaming); Bonanza Megaways (Big Time Gaming) | Each reel draws a random number of rows every spin, so the ways count changes spin to spin. |
...
| Mechanic | Status | Works on | From these games | What it does |
|---|---|---|---|---|
| **Network progressive jackpot**<br>`network_jackpot` | `blocked` T3 | any | Mega Joker (NetEnt) | A prize pool accumulating across players and games. |
| **Gamble / double-up**<br>`gamble` | `blocked` T2 | any | Extra Chilli (Big Time Gaming) | Stake a win on a coin flip or card draw to double it. |
...
| Buffalo King Megaways | Pragmatic Play | 5,000x | megaways, ways_pays, tumble, freespins, sticky_multiplier, buy_bonus |
| The Dog House Megaways | Pragmatic Play | 12,000x | megaways, ways_pays, tumble, freespins, sticky_wild, sticky_multiplier, buy_bonus |
| Extra Chilli | Big Time Gaming | 20,000x | megaways, ways_pays, tumble, freespins, gamble, buy_bonus |
| Blood Suckers | NetEnt | 1,000x | lines_pays, freespins, expanding_wild |
| Mega Joker | NetEnt | — | lines_pays, network_jackpot |
| Razor Ways | Push Gaming | 50,000x | ways_pays, mystery_stack, freespins, progressive_global_multiplier, buy_bonus |
| R.I.P. City | Hacksaw Gaming | 12,500x | lines_pays, freespins, multi_mode_feature, tiered_buy_menu, buy_bonus |
| Dork Unit | Hacksaw Gaming | 10,000x | lines_pays, expanding_special_symbol, sticky_wild, freespins, buy_bonus |
| Money Train 3 | Relax Gaming | 100,000x | lines_pays, hold_and_win, money_symbol, collector_symbol, payer_symbol, special_symbol_roles, buy_bonus |
| Iron Bank | Relax Gaming | 40,000x | lines_pays, hold_and_win, money_symbol, collector_symbol, freespins, buy_bonus |
| Bonanza Megaways | Big Time Gaming | 26,000x | megaways, ways_pays, tumble, freespins, progressive_cascade_multiplier |
